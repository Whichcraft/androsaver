...
class TesseractMode : BaseMode() {
    ...
    override fun draw(draw: GLDraw, audio: AudioData, tick: Int) {
        ...
        // Match Cube's restrained breathing and vertical beat bounce so the
        // object remains legible instead of becoming a static colour blob.
